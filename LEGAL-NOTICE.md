...
**The game is not ours.** *Knightmare* was published by **Konami** for the MSX in 1986;
its catalogue number is **RC-739** and it is 32 KB. All rights over the game
...
The file `src/knightmare.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Knightmare* or hold rights over the game, and you would rather this
